...
{
    public class PrefetchVideoWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return PrefetchVideoDefinition.PrefetchVideoWorkSpacePluginId; }
        }
        ...
        {
            get { return "Tape Prefetch (Orbisis)"; }
        }
        ...
        public override void Init()
        {
           ...
           /* rectangles.Add(new Rectangle(000, 000, 200, 200)); */     // Index 0 = Used by a camera below
            rectangles.Add(new Rectangle(000, 000, 1000, 800));      // Index 1 = the sample ViewItem
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(0, new PrefetchVideoWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
