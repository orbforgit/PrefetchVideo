...
namespace PrefetchVideo.Client
{
    ...
    /// </summary>
    public class PrefetchVideoViewItemPlugin : ViewItemPlugin
    {

        public PrefetchVideoViewItemPlugin()
        {
        }
        ...
        {
            get { return PrefetchVideoDefinition.PrefetchVideoViewItemPlugin; }
        }
        ...
        {
            return new PrefetchVideoViewItemManager();
        }
