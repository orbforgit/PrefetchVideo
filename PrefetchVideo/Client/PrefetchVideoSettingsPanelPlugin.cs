...
{
    public class PrefetchVideoSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return PrefetchVideoDefinition.PrefetchVideoSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "TapePrefetch(Orbisis)"; } }
        ...
        {
            _userControl = new PrefetchVideoSettingsPanelControl(this);
            return _userControl;
        }
