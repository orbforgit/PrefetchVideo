...
{
    class PrefetchVideoViewItemToolbarPluginInstance : ViewItemToolbarPluginInstance
    {
        ...
        public override void Init(Item viewItemInstance, Item window)
        {
            ...
            Tooltip = "TapePrefetch(Orbisis) tooltip";
        }
    ...
    class PrefetchVideoViewItemToolbarPlugin : ViewItemToolbarPlugin
    {
        public override Guid Id
        {
            get { return PrefetchVideoDefinition.PrefetchVideoViewItemToolbarPluginId; }
        }
        ...
        {
            // TODO: remove below check when PrefetchVideoDefinition.PrefetchVideoViewItemToolbarPluginId has been replaced with proper GUID
            if (Id == new Guid("33333333-3333-3333-3333-333333333333"))
            {
                System.Windows.MessageBox.Show("Default GUID has not been replaced for PrefetchVideoViewItemToolbarPluginId!");
            }

            ViewItemToolbarPlaceDefinition.ViewItemIds = new List<Guid>() { ViewAndLayoutItem.CameraBuiltinId };
            ViewItemToolbarPlaceDefinition.WorkSpaceIds = new List<Guid>() { ClientControl.LiveBuildInWorkSpaceId, ClientControl.PlaybackBuildInWorkSpaceId, PrefetchVideoDefinition.PrefetchVideoWorkSpacePluginId };
        ...
        {
            return new PrefetchVideoViewItemToolbarPluginInstance();
        }
    }
}
