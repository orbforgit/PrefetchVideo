...
namespace PrefetchVideo.Client
{
    ...
    /// </summary>
    public class PrefetchVideoViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public PrefetchVideoViewItemManager() : base("PrefetchVideoViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(PrefetchVideoDefinition.PrefetchVideoPluginId, null, PrefetchVideoDefinition.PrefetchVideoKind);
        ...
        //{
        //	return new PrefetchVideoViewItemUserControl(this);
        //}
        ...
        {
            return new PrefetchVideoViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new PrefetchVideoPropertiesUserControl(this);
        //}
        ...
        {
            return new PrefetchVideoPropertiesWpfUserControl(this);
        }
