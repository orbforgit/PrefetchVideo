...
namespace PrefetchVideo.Client
{
    ...
    /// </summary>
    public partial class PrefetchVideoViewItemWpfUserControl : ViewItemWpfUserControl
    {
        #region Component private class variables

        private PrefetchVideoViewItemManager _viewItemManager;
        ...
        /// <summary>
		/// Constructs a PrefetchVideoViewItemUserControl instance
        /// </summary>
		public PrefetchVideoViewItemWpfUserControl(PrefetchVideoViewItemManager viewItemManager)
        {
