...
namespace PrefetchVideo.Client
{
    ...
    /// </summary>
    public class PrefetchVideoSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new PrefetchVideoSidePanelUserControl();
        //}
        ...
        {
            return new PrefetchVideoSidePanelWpfUserControl();
        }
        ...
        {
            get { return PrefetchVideoDefinition.PrefetchVideoSidePanel; }
        }
