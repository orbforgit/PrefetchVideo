...
{
    public partial class PrefetchVideoTabUserControl : VideoOS.Platform.Admin.TabUserControl
    {
        private Item _associatedItem;
        private bool _ignoreChanged = false;
        private AssociatedProperties _associatedProperties;

        public PrefetchVideoTabUserControl(Item item)
        {
            InitializeComponent();
        ...
        public override void Init()
        {
            ...
            _associatedProperties = Configuration.Instance.GetAssociatedProperties(_associatedItem, PrefetchVideoDefinition.PrefetchVideoTabPluginId);
