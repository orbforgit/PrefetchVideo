...
namespace PrefetchVideo.Admin
{
    ...
    /// </summary>
    public class PrefetchVideoItemManager : ItemManager
    {
        private PrefetchVideoUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public PrefetchVideoItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new PrefetchVideoUserControl();
        ...
        {
            return new PrefetchVideoAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(PrefetchVideoDefinition.PrefetchVideoPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((PrefetchVideoAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(PrefetchVideoDefinition.PrefetchVideoPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(PrefetchVideoDefinition.PrefetchVideoPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(PrefetchVideoDefinition.PrefetchVideoPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(PrefetchVideoDefinition.PrefetchVideoPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(PrefetchVideoDefinition.PrefetchVideoPluginId, _kind, fqid.ObjectId);
            return item;
        }
